    ...
    <main className="min-h-screen bg-background text-foreground font-body scroll-smooth">
      ...
      <section className="relative overflow-hidden pt-40 sm:pt-48 md:pt-64 pb-12">
        <img
          ...
          loading="lazy"
        />
        <div className="absolute inset-0" style={{ background: "<div className="absolute inset-0" style={{ background: "linear-gradient(to bottom, hsla(var(--background) / 0.1), hsla(var(--background) / 0.35) 50%, hsla(var(--background) / 0.8) 75%, hsl(var(--background)))" }} />" }} />
